    ...
    <section className={styles.spiker}>
      <div className={styles.container}>
        <div className={styles.top}>
          <h3>Наши <span>лучшие спикеры</span> страны!</h3>  
          <div className={styles.arrows}>
            <button
              className={`${styles.btn2} swiper-button-prev ${activeNav === "prev" ? styles.active : ""}`}
          ...
          {data.map((item, i) => (
            <SwiperSlide key={i}>
              <div className={styles.box}>
                <Image src={item.img} alt={item.name} width={295} height={295} style={{ width: "100%", height: "auto" }} />
